...
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (5, 'Nick', 'Green', 'nick@mail.com', '$2a$10$ljxwhE789VmXvVhsMIK0sezhLajyAmncn5n6WPT5lDEAlVodZekpa', 2); -- user (password 1111)
...
INSERT INTO users (id, first_name, last_name, email, password, role_id) VALUES (4, 'Mike', 'Brown', 'mike@mail.com', '$2a$10$iX1gCcJZkddbgUlLFEXU5uw3P2yBBrdE5SqaMucCWJwjX98wtsjga', 1); -- admin (password 2222)
